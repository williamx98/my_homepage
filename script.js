...
$(function() {
  ...
  $(function() {
    $('#videoControl').on('click', function(e) {
      e.preventDefault();
      if (!shown) {
        $('#youtube').addClass("show-video")
        $('#youtube').removeClass("hide-video")
        $('#videoControl').text("Hide Video");
      } else {
        $('#youtube').removeClass("show-video")
        $('#youtube').addClass("hide-video")
        $('#videoControl').text("Show Video");
      }
      shown = !shown
    });
  });
